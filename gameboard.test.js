...
test('check if gameboard is working correctly', () => {
    const newGameboard = Gameboard(1,2,3);
    expect(newGameboard.newShip.x).toBe(1);
    ...
    expect(newGameboard.recordMissedShots).toEqual([[6,7],[55,33]]);
}) 